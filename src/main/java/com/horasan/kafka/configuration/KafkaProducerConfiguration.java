...
public class KafkaProducerConfiguration {
	...
	KafkaTemplate<String, String> kafkaTemplate() {
		...
		kafkaTemplate.setDefaultTopic("customer-create-requests");
	...
	public RoutingKafkaTemplate routingTemplate(GenericApplicationContext context) {
		System.out.println("routingTemplate");
	...
	@Bean
	public ProducerFactory<String, ServerStatus> serverStatusProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String, ServerStatus> userKafkaTemplate() {
		return new KafkaTemplate<>(serverStatusProducerFactory());
	}
